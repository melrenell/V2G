...
project = v2gsim.itinerary.from_excel(project, 'Schoolbus_2500.xlsx')
...
#Currently using fake netload data 2025.xlsx
net_load=pandas.read_excel('FERC_restructured2.xlsx')
#net_load = pandas.DataFrame(net_load[day: day + datetime.timedelta(days=1)]['netload'])
net_load = pandas.DataFrame(net_load)
...
plt.title('NC netload w/ 2500 V2G Buses')
plt.ylabel('Power (MW)')
